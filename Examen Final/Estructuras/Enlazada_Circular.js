...
class ListaEC{
    ...
    print(){
        ...
        let current = this.head;
        let lecbody = document.querySelector('#lecbody')
        lecbody.innerHTML=''
            for(let i=0;i<this.size;i++){
                lecbody.innerHTML+=`
                <tr>
    ...
    getSize(){
        return alert("la lista tiene: "+this.size+" elementos")
    }
    ...
    getLast(){
        ...
        if(this.getSize===0){
            ...
            return alert("El Ultimo elemento es: "+tail.dato)
        }
    }
